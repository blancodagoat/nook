...
Fill this in after running the spike tools on a **Kettu** device.

References:
- [Kettu API cross-reference](./kettu-plugin-api-reference.md)
- [Vendetta Plugin Docs](https://plugindocs.nexpid.xyz) (legacy concepts)
...
4. Enable **Debug mode** in plugin settings, then run metro discovery on an open channel

## Test environment

- Discord app version:
- Kettu version / loader:
