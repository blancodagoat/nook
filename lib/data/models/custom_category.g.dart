...
CustomCategory _customCategoryDeserialize(
  ...
  final object = CustomCategory(
    colorHex: reader.readStringOrNull(offsets[0]) ?? '#6366F1',
...
P _customCategoryDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readStringOrNull(offset) ?? '#6366F1') as P;
    case 1:
...
extension CustomCategoryQueryWhere
  ...
  QueryBuilder<CustomCategory, CustomCategory, QAfterWhereClause> typeEqualTo(
      String type) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'type',
...
extension CustomCategoryQuerySortBy
  ...
  QueryBuilder<CustomCategory, CustomCategory, QAfterSortBy> sortByColorHex() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CustomCategory, CustomCategory, QAfterSortBy> sortByEmoji() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'emoji', Sort.asc);
    });
  }

  QueryBuilder<CustomCategory, CustomCategory, QAfterSortBy> sortByEmojiDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CustomCategory, CustomCategory, QAfterSortBy> sortByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<CustomCategory, CustomCategory, QAfterSortBy> sortByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomCategoryQuerySortThenBy
  ...
  QueryBuilder<CustomCategory, CustomCategory, QAfterSortBy> thenByColorHex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'colorHex', Sort.asc);
    });
  }
  ...
  QueryBuilder<CustomCategory, CustomCategory, QAfterSortBy> thenByEmoji() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'emoji', Sort.asc);
    });
  }

  QueryBuilder<CustomCategory, CustomCategory, QAfterSortBy> thenByEmojiDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'emoji', Sort.desc);
    });
  }
  ...
  QueryBuilder<CustomCategory, CustomCategory, QAfterSortBy> thenByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<CustomCategory, CustomCategory, QAfterSortBy> thenByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.desc);
    });
  }
...
extension CustomCategoryQueryWhereDistinct
  ...
  QueryBuilder<CustomCategory, CustomCategory, QDistinct> distinctByColorHex(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CustomCategory, CustomCategory, QDistinct> distinctByEmoji(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CustomCategory, CustomCategory, QDistinct> distinctByType(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CustomCategoryQueryProperty
  ...
  QueryBuilder<CustomCategory, String, QQueryOperations> colorHexProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'colorHex');
    });
  }

  QueryBuilder<CustomCategory, String, QQueryOperations> emojiProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CustomCategory, String, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
